...
const ERROR_MESSAGES = {
  GET: 'Не удалось загрузить фотографии. Попробуйте обновить страницу',
...
export {NAMES, MESSAGES, DESCRIPTIONS, POSTS_COUNT, MIN_LIKES, MAX_LIKES, MIN_COMMENTS, MAX_COMMENTS,
  MIN_AVATAR, MAX_AVATAR, MIN_MESSAGES_COUNT,MAX_MESSAGES_COUNT, LOAD_COMMENTS_COUNT, HASHTAG_REGEX,
  MAX_HASHTAGS, MAX_COMMENT_LENGTH, SERVER_URL, GET_DATA_URL, ERROR_MESSAGES, RANDOM_PHOTOS_COUNT, FILTER_DEFAULT,FILTER_RANDOM,
  FILTER_DISCUSSED, RERENDER_DELAY, FILE_TYPES};
